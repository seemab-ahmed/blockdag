...
const BuyMiner = () => {
  ...
  const handleIncrement = (minerType) => {
    setMinerCounts(prev => ({
      ...prev,
      [minerType]: prev[minerType] + 1
    }));
  };

  const handleDecrement = (minerType) => {
    if (minerCounts[minerType] > 0) {
      setMinerCounts(prev => ({
        ...prev,
        [minerType]: prev[minerType] - 1
      }));
      ...
      <div className="wallet_walletHead__N6OWX">
        <div className="wallet_walletHeadCoin__G_Gxn">
          <div className="wallet_walletHeadItem__2_GYQ">
            <p className="style_text__Z44aT style_sm__RimS5 style_primary__o7qgw">Total Miner Sales</p>
            <p className="style_text__Z44aT style_md__ZQhe4 style_font-700__9q48B">$7,589,410</p>
          </div>
          <div className="wallet_walletHeadItem__2_GYQ">
            <p className="style_text__Z44aT style_sm__RimS5 style_primary__o7qgw">Total Miners Sold</p>
            <p className="style_text__Z44aT style_md__ZQhe4 style_font-700__9q48B">18564</p>
          </div>
        </div>
      </div>
      
      <div className="wallet_walletContent__3lxb6">
        <div className="wallet_miners__hRCq_">
          {/* Miner X10 */}
          <div className="MinerBox_minerbox__lOvUo">
            <div className="MinerBox_content__e4IBG">
              <div>
                <div className="MinerBox_photoBg__tp5IT">
                  <img alt="Miner" loading="lazy" width="0" height="0" decoding="async" className="MinerBox_photo__TDKap" src="https://purchase3.blockdag.network/images/products/x10-fill.png" style={{ color: 'transparent' }} />
                </div>
                ...
                <p className="style_text__Z44aT style_sm__RimS5">
                  <span style={{ color: 'rgb(254, 64, 10)' }}>low </span>Miner
                </p>
              </div>
            </div>
            <div className="MinerBox_quantity__r0lb7">
              <img alt="Miner" loading="lazy" width="80" height="80" decoding="async" className="MinerBox_icon__03Hsr" src="https://purchase3.blockdag.network/images/calculator/bdag-x10.svg" style={{ color: 'transparent' }} />
              <div className="MinerBox_minus__qSin_" onClick={() => handleDecrement('x10')}>
                <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.66675 16.5H25.3334" stroke="currentColor" strokeWidth="2.66667" strokeLinecap="round" strokeLinejoin="round"></path>
                </svg>
              </div>
              <div>
                <p className="style_text__Z44aT style_sm__RimS5">{minerCounts.x10}</p>
              </div>
              <div className="MinerBox_plus__s5MM8" onClick={() => handleIncrement('x10')}>
                <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.0001 7.16699V25.8337M6.66675 16.5003H25.3334" stroke="currentColor" strokeWidth="2.66667" strokeLinecap="round" strokeLinejoin="round"></path>
                </svg>
              </div>
            </div>
          </div>
          ...
          <div className="MinerBox_minerbox__lOvUo">
            <div className="MinerBox_content__e4IBG">
              <div>
                <div className="MinerBox_photoBg__tp5IT">
                  <img alt="Miner" loading="lazy" width="0" height="0" decoding="async" className="MinerBox_photo__TDKap" src="https://purchase3.blockdag.network/images/products/x30-1.webp" style={{ color: 'transparent' }} />
                </div>
                <p className="style_text__Z44aT style_sm__RimS5 style_font-700__9q48B">BlockDAG X30</p>
                <p className="style_text__Z44aT style_sm__RimS5">
                  <span style={{ color: 'rgb(243, 222, 109)' }}>medium </span>Miner
                </p>
              </div>
            </div>
            <div className="MinerBox_quantity__r0lb7">
              <img alt="Miner" loading="lazy" width="80" height="80" decoding="async" className="MinerBox_icon__03Hsr" src="https://purchase3.blockdag.network/images/calculator/bdag-x30.svg" style={{ color: 'transparent' }} />
              <div className="MinerBox_minus__qSin_" onClick={() => handleDecrement('x30')}>
                <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.66675 16.5H25.3334" stroke="currentColor" strokeWidth="2.66667" strokeLinecap="round" strokeLinejoin="round"></path>
                </svg>
              </div>
              <div>
                <p className="style_text__Z44aT style_sm__RimS5">{minerCounts.x30}</p>
              </div>
              <div className="MinerBox_plus__s5MM8" onClick={() => handleIncrement('x30')}>
                <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.0001 7.16699V25.8337M6.66675 16.5003H25.3334" stroke="currentColor" strokeWidth="2.66667" strokeLinecap="round" strokeLinejoin="round"></path>
                </svg>
              </div>
          ...
          <div className="MinerBox_minerbox__lOvUo">
            <div className="MinerBox_content__e4IBG">
              <div>
                <div className="MinerBox_photoBg__tp5IT">
                  <img alt="Miner" loading="lazy" width="0" height="0" decoding="async" className="MinerBox_photo__TDKap" src="https://purchase3.blockdag.network/images/products/x100-1.webp" style={{ color: 'transparent' }} />
                </div>
                <p className="style_text__Z44aT style_sm__RimS5 style_font-700__9q48B">BlockDAG X100</p>
                <p className="style_text__Z44aT style_sm__RimS5">
                  <span style={{ color: 'rgb(104, 223, 101)' }}>high </span>Miner
                </p>
              </div>
            </div>
            <div className="MinerBox_quantity__r0lb7">
              <img alt="Miner" loading="lazy" width="80" height="80" decoding="async" className="MinerBox_icon__03Hsr" src="https://purchase3.blockdag.network/images/calculator/bdag-x100.svg" style={{ color: 'transparent' }} />
              <div className="MinerBox_minus__qSin_" onClick={() => handleDecrement('x100')}>
                <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M6.66675 16.5H25.3334" stroke="currentColor" strokeWidth="2.66667" strokeLinecap="round" strokeLinejoin="round"></path>
                </svg>
              </div>
              <div>
                <p className="style_text__Z44aT style_sm__RimS5">{minerCounts.x100}</p>
              </div>
              <div className="MinerBox_plus__s5MM8" onClick={() => handleIncrement('x100')}>
                <svg width="32" height="33" viewBox="0 0 32 33" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M16.0001 7.16699V25.8337M6.66675 16.5003H25.3334" stroke="currentColor" strokeWidth="2.66667" strokeLinecap="round" strokeLinejoin="round"></path>
                </svg>
              </div>
        ...
        <div className="wallet_otherMethods__BOKMM">
          <div className="wallet_otherCryptos__2TkU1">
            <p>
              ...
              <img alt="Kaspa" loading="lazy" width="24" height="24" decoding="async" src="https://purchase3.blockdag.network/images/coins/kas.svg" style={{ color: 'transparent' }} />
              <img alt="DOGE" loading="lazy" width="24" height="24" decoding="async" src="https://purchase3.blockdag.network/images/coins/doge.svg" style={{ color: 'transparent' }} />
              <img alt="Shiba Inu" loading="lazy" width="24" height="24" decoding="async" src="https://purchase3.blockdag.network/images/coins/shib.svg" style={{ color: 'transparent' }} />
              <img alt="extra" loading="lazy" width="24" height="24" decoding="async" className="wallet_extra__ZLA9e" src="https://purchase3.blockdag.network/images/extra.svg" style={{ color: 'transparent' }} />
        ...
        <div className="wallet_purchaseMethods__n4mDq">
          <div className="style_input__d5JsO">
            ...
            <p className="style_text__Z44aT style_sm__RimS5 style_infoDesc__MIj8g text-warning">
              {Object.values(minerCounts).every(count => count === 0) ? 'Please select your miner.' : ''}
            </p>
          </div>
          <button 
            type="button" 
          ...
          >
            Buy Miners<span className="style_wrap__yFGLp"></span>
          </button>
        </div>
