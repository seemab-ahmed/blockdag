...
export default function WalletPurchaseMethods({
  ...
  const [minAmounts, setMinAmounts] = useState({ ETH: null, BNB: null, USDT: MIN_PURCHASE_USD });
  ...
  useEffect(() => {
    async function fetchPrices() {
      try {
        ...
        setMinAmounts({
          ETH: (MIN_PURCHASE_USD / eth).toFixed(6),
          BNB: (MIN_PURCHASE_USD / bnb).toFixed(6),
          USDT: MIN_PURCHASE_USD
        });
      } catch {
