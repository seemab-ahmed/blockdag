...
const { disconnect } = useDisconnect();
  ...
  const bonusPercent = profile["Bonus%"];
  const basePercent = profile["Base%"];
            ...
            <div className="profile_chart__R3bOy">
              <div className="style_chart__4Dhsv">
                <svg className="style_donut__h_f_T" width="300" height="300" viewBox="-150 -150 300 300">
                  ...
                  <text x="50.00906872264892" y="86.59730391584588" fill="#FFF" fontSize="18" fontWeight="bold" textAnchor="middle" dominantBaseline="middle">{basePercent}</text>
                  ...
                  <text x="-99.99999506519785" y="0.031415926019190236" fill="#FFF" fontSize="18" fontWeight="bold" textAnchor="middle" dominantBaseline="middle">{bonusPercent}</text>
