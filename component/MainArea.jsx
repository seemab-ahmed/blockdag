...
//    if (!amount || parseFloat(amount) <= 0) {
//     setTransactionStatus({ isLoading: false, message: "Enter a valid amount.", isError: true });
//     return;
//   }
...
//     // Always get signer from connected wallet provider
//     const provider = new ethers.providers.Web3Provider(await wallet.getEthereumProvider());
    
//     // Auto-switch to correct chain before sending
//     if (activePaymentMethod === "BNB") {
//       await provider.send("wallet_switchEthereumChain", [{ chainId: "0x38" }]); // BNB Mainnet
//     } else if (activePaymentMethod === "ETH") {
//       await provider.send("wallet_switchEthereumChain", [{ chainId: "0x1" }]); // ETH Mainnet
//     }
...
//       if (balance.lt(amountUnits)) {
//         throw new Error(`Insufficient USDT balance. You have ${ethers.utils.formatUnits(balance, 6)} USDT`);
//       }

//       tx = await contract.transfer(DESTINATION_WALLET, amountUnits, { gasLimit: 100000 });
//     }
