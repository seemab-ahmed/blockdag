      ...
      <div className="style_purchase__X5B7u">
          ...
          <div className="wallet_walletWrapper__6pNfN">
            <div className="wallet_walletHead__N6OWX">
              ...
              <div className="wallet_doubleIt__OhJ0r">
                <p className="wallet_doubleText__JRiZM __className_665d18">BUY, BEAT VESTING PASS!</p>
              </div>
            ...
            <div className="wallet_walletContent__3lxb6">
              <div className="wallet_purchaseMethods__n4mDq">
                <div className="selectMethodBox_selecttype__Omlpg">
                  <div className="selectMethodBox_item__09JVV selectMethodBox_active__EdF_w">
                  ...
                  <div className="selectMethodBox_item__09JVV ">
        ...
        onChange={e => setAmount(e.target.value)}  />
                    <div className="wallet_selectedMethodCurrencyLabel__YO_mf">
                      <p className="style_text__Z44aT style_md__ZQhe4">ETH</p>
                    </div>
                ...
                <button type="button" disabled="" className="style_button__C9H72 wallet_buyBtn___PtJa style_primary__FoPQF">Buy Coins<span className="style_wrap__yFGLp"></span></button>
              </div>
